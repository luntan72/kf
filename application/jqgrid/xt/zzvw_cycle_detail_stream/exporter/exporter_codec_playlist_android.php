...
class xt_zzvw_cycle_detail_stream_exporter_codec_playlist_android extends exporter_txt{
	...
	protected function _export(){
		...
		$str .= '				<cmd action="CheckCurrentPositionPercentage" pos="50" tolerance="5"/>'."\n";
		$str .= '				<cmd action="Sleep" time="5"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";
		$str .= "\n";
		...
		$str .= "\n";			  
		$str .= '			<operation tag="seek">'."\n";
		$str .= '				<cmd action="SeekToMsec" pos="-2000"/>'."\n";
		$str .= '				<cmd action="CheckCurrentPositionMsec" pos="-2000" tolerance="5"/>'."\n";
		$str .= '				<cmd action="Sleep" time="5"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";
		$str .= "\n";	
		...
		$str .= '			</operation>'."\n";
		$str .= "\n";			  
		$str .= '			<operation tag="slowforward">'."\n";
		$str .= '				<cmd action="SetPlaySpeed" speed="0.5"/>'."\n";
		$str .= '				<cmd action="Sleep" time="5"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";
		$str .= "\n";	
		$str .= '			<operation tag="slowforward">'."\n";
		$str .= '				<cmd action="SetLooping" IsLooping="true"/>'."\n";
		$str .= '				<cmd action="SetPlaySpeed" speed="1.5"/>'."\n";
		$str .= '				<cmd action="Sleep" time="5"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";
		$str .= "\n";		
		$str .= '			<operation tag="fastforward">'."\n";
		$str .= '			    <cmd action="SetLooping" IsLooping="true"/>'."\n";
		$str .= '			    <cmd action="SeekToPercentage" pos="1"/>'."\n";
		$str .= '			    <cmd action="Sleep" time="1"/>'."\n";
		$str .= '				<cmd action="SetPlaySpeed" speed="2"/>'."\n";
		$str .= '				<cmd action="Sleep" time="5"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";
		$str .= "\n";			  
		$str .= '			<operation tag="fastbackward">'."\n";
		$str .= '			    <cmd action="SetPlaySpeed" speed="1"/>'."\n";
		$str .= '			    <cmd action="SeekToPercentage" pos="90"/>'."\n";
		$str .= '			    <cmd action="Sleep" time="1"/>'."\n";
		$str .= '				<cmd action="SetPlaySpeed" speed="-2"/>'."\n";
		$str .= '				<cmd action="Sleep" time="5"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		...
		$str .= '			</operation>'."\n";			  
		$str .= '			<operation tag="seek">'."\n";
		$str .= '				<cmd action="SeekToPercentage" pos="20"/>'."\n";
		$str .= '				<cmd action="Sleep" time="5"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";			  
		$str .= '			<operation tag="resume">'."\n";
		...
		$str .= '		</trickmode>'."\n";	
		$str .= ''."\n";	
		$str .= '		<trickmode desc="pauseResume">'."\n";
		$str .= '			<operation tag="open">'."\n";
		$str .= '				<cmd action="GetMEMStat"/>'."\n";
		$str .= '				<cmd action="OpenMedia"/>'."\n";
		$str .= '				<cmd action="Sleep" time="1"/>'."\n";
		...
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";
		$str .= '			<operation tag="trackswitch">'."\n";
		$str .= '				<cmd action="AudioSubtitleTrackSwitch" />'."\n";
		$str .= '				<cmd action="Sleep" time="1"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";                            
		$str .= '			<operation tag="seek">'."\n";
		$str .= '				<cmd action="SeekToPercentage" pos="50"/>'."\n";
		$str .= '				<cmd action="Sleep" time="0"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";
		$str .= '			<operation tag="trackswitch">'."\n";
		$str .= '				<cmd action="AudioSubtitleTrackSwitch"/>'."\n";
		...
		$str .= '			</operation>'."\n";    
		$str .= '			<operation tag="seek">'."\n";
		$str .= '				<cmd action="SeekToPercentage" pos="5"/>'."\n";
		$str .= '				<cmd action="Sleep" time="1"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n"; 
		$str .= '			<operation tag="pause">'."\n";
		...
		$str .= '			</operation>'."\n";
		$str .= '			<operation tag="seek">'."\n";
		$str .= '				<cmd action="SeekToPercentage" pos="95"/>'."\n";
		$str .= '				<cmd action="Sleep" time="1"/>'."\n";
		$str .= '				<cmd action="GetAllErrors"/>'."\n";
		$str .= '			</operation>'."\n";  
		$str .= '			<operation tag="trackswitch">'."\n";
		...
		$sql = "SELECT detail.cycle_id, detail.codec_stream_id, stream.code, stream.location, module.name as module, stream.name as s_name,".
		...
		while ($row = $res->fetch()){
			if(!empty($row['code'])){
				...
				$str .= '			</audio>'."\n";
				//streams of only audio use audio_duration, streams of only video use video_duration, the others duration
				...
				$str .= '		</streaminfo>'."\n";
				$str .= '		<trickmodeinfo>'."\n";
				$new_sql = "SELECT GROUP_CONCAT(DISTINCT testcase.code) AS trickmodeinfo FROM cycle_detail detail".
					" LEFT JOIN testcase on testcase.id = detail.testcase_id".
					" WHERE detail.cycle_id = {$row['cycle_id']} AND detail.codec_stream_id = {$row['codec_stream_id']}";
				$new_res = $db->query($new_sql);
				if($info = $new_res->fetch()){
					$str .= "			{$info['trickmodeinfo']}"."\n";
				}
				$str .= '		</trickmodeinfo>'."\n";
				$str .= '	</teststream>'."\n";
			}
