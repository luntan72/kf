...
// print_r($params);		
		...
		if($this->params['action_name'] == 'information' || $this->params['action_name'] == 'update_information_page'){
        ...
        $this->options['list'] = array(
			...
			// 'plan_date'=>array('label'=>'交付日期'),
			'expire_date'=>array('label'=>'失效期'),
		...
		$this->options['edit'] = array(
			// 'wz_fl_id'=>array('editable'=>true, 'label'=>'物资类型'), 
			'wz_id'=>array('editable'=>false), 'defect_id'=>array('editable'=>true), 'price', 'amount', 'dingdan_jfjh', 'expire_date', 'dingdan_status_id'=>array('type'=>'hidden'));
		$this->options['add'] = array(
			// 'wz_fl_id'=>array('editable'=>true, 'label'=>'物资类型'), 
			'wz_id'=>array('editable'=>true), 
			'defect_id'=>array('editable'=>true), 
			'price', 'amount', 'dingdan_jfjh', 'expire_date', 'dingdan_status_id'=>array('type'=>'hidden'));
	}
	
	protected function _setSubGrid(){
        $this->options['gridOptions']['subGrid'] = true;
		$this->options['subGrid'] = array('expandField'=>'dingdan_id', 'db'=>'qygl', 'table'=>'zzvw_yw_fh_detail');
	}
