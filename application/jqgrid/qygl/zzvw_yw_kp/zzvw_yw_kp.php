...
//下采购单
class qygl_zzvw_yw_kp extends qygl_yw{
	protected function init($params){
// print_r($params);
		parent::init($params);
		$this->options['list']['hb_id']['label'] = '客户';
		$this->options['list']['hb_id']['data_source_table'] = 'zzvw_kh';
		$this->options['list']['yw_fl_id']['type'] = 'hidden';
		$this->options['list']['yw_fl_id']['defval'] = YW_FL_KFP;
		$this->options['list']['happen_date']['label'] = '开票日期';
		$this->options['edit']['yw_fl_id']['type'] = 'hidden';
		$this->options['edit']['yw_fl_id']['defval'] = YW_FL_KFP;
		$this->options['add']['yw_fl_id']['type'] = 'hidden';
		$this->options['add']['yw_fl_id']['defval'] = YW_FL_KFP;
		$this->options['caption'] = '开发票';
