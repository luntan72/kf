...
// print_r($pair);		
		...
		$chuku = array('yw_id'=>$pair['yw_id'], 'gx_id'=>GX_LAST, 'wz_id'=>$this->params['wz_id'], 'defect_id'=>1, 'amount'=>$pair['amount'], 'dingdan_id'=>$pair['dingdan_id']);
		$model->chuku($chuku, $pair['pici_id'], YW_FL_FH);
