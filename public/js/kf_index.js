...
// // alert("url = " + url + ", title = " + title);	
	...
	this.index_help = function(){
		return this.newTab('/index/help', mainDiv, 'help');
	}

	this.index_aboutUs = function(){
		return this.newTab('/index/aboutus', mainDiv, 'about us');
	}

	this.userAdmin_register = function(){
		return this.newTab('/useradmin/register', mainDiv, 'register');
	}
	...
	this.userAdmin_index = function(){
		return this.newTab('/useradmin/index', mainDiv, 'home');
	}

	this.userAdmin_changePassword = function(){
		return this.newTab('/useradmin/changepassword', mainDiv, 'Change Password');
	}

	this.userAdmin_updateProfile = function(){
		return this.newTab('/useradmin/updateprofile', mainDiv, 'Update Profile');
	}
